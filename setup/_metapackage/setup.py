...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-l10n_br_account_nfe>=15.0dev,<15.1dev',
        ...
        'odoo-addon-l10n_br_cnab_structure>=15.0dev,<15.1dev',
        ...
        'odoo-addon-l10n_br_cte>=15.0dev,<15.1dev',
        'odoo-addon-l10n_br_cte_spec>=15.0dev,<15.1dev',
        ...
        'odoo-addon-l10n_br_fiscal_closing>=15.0dev,<15.1dev',
